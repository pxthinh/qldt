...
def staff_required(require_manager=False):
    ...
    def decorator(view_func):
        # Make the view CSRF exempt
        view_func = csrf_exempt_for_api(view_func)
            ...
            try:
                ...
                if is_staff_management and require_manager:
                    ...
                    is_manager = (
                        ...
                        (hasattr(request.user, 'subordinates') and request.user.subordinates.exists())  # Has subordinates
                    )
                    if not is_manager:
                        return JsonResponse(
